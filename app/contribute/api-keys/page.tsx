      ...
      <div className="w-full max-w-md rounded-2xl p-6" style={{ background: "#1c1c21", border: "1px solid #2a2f3a" }}>
        ...
        <div className="flex gap-3">
          <button
            ...
            style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #2a2f3a", color: "#eaeaea", fontFamily: "var(--font-montserrat), sans-serif" }}
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all hover:scale-[1.01]"
            style={{ background: "rgba(194,53,63,0.15)", border: "1px solid rgba(194,53,63,0.4)", color: "#c2353f", fontFamily: "var(--font-montserrat), sans-serif" }}
          >
            Revoke Key
          </button>
        </div>
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <h3 className="text-sm font-bold" style={{ color: "#eaeaea", fontFamily: "var(--font-montserrat), sans-serif" }}>{k.label}</h3>
        ...
        <button
          ...
          style={{ background: "rgba(194,53,63,0.08)", border: "1px solid rgba(194,53,63,0.2)", color: "#c2353f", fontFamily: "var(--font-montserrat), sans-serif" }}
        >
  ...
  return (
    <div className="w-full space-y-8">
      ...
      <div className="rounded-2xl p-6" style={{ background: "#1c1c21", border: "1px solid #2a2f3a" }}>
        <h2 className="text-base font-bold mb-4" style={{ color: "#eaeaea", fontFamily: "var(--font-montserrat), sans-serif" }}>Create New Key</h2>
        <GenerateKeyForm onGenerated={() => setRefreshKey((k) => k + 1)} />
      </div>

      {/* Existing keys */}
      <div>
        <h2 className="text-base font-bold mb-4" style={{ color: "#eaeaea", fontFamily: "var(--font-montserrat), sans-serif" }}>
