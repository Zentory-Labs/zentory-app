...
function PublishResearchForm({ apiKey, onSuccess }: { apiKey: string; onSuccess: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {error && (
        <p className="text-xs rounded-lg px-3 py-2" style={{ background: "rgba(194,53,63,0.1)", border: "1px solid rgba(194,53,63,0.3)", color: "#c2353f", fontFamily: "var(--font-montserrat), sans-serif" }}>
          {error}
        </p>
      )}
      {success && (
        <p className="text-xs rounded-lg px-3 py-2" style={{ background: "rgba(52,211,153,0.1)", border: "1px solid rgba(52,211,153,0.3)", color: "#34d399", fontFamily: "var(--font-montserrat), sans-serif" }}>
    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs uppercase tracking-widest font-semibold" style={{ color: "#b08d57", fontFamily: "var(--font-montserrat), sans-serif" }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Publish form */}
        <div className="rounded-2xl p-6" style={{ background: "#1c1c21", border: "1px solid #2a2f3a" }}>
          <h2 className="text-base font-bold mb-5" style={{ color: "#eaeaea", fontFamily: "var(--font-montserrat), sans-serif" }}>
            Publish Research
          </h2>
